...
class HostelLPage extends StatelessWidget {
  @override
              ...
              Center(
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/hostelL.jpeg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Stack(
                        ...
                        child: Row(
                          ...
                          children: [
                            IconButton(
                                ...
                                color: Colors.black,
                                onPressed: () {
                                  Navigator.pushNamed(context, '/hostelB');
                                }),
                            const Text(
                              "Bla Bla \nHALL",
                            ...
                            IconButton(
                                ...
                                color: Colors.black,
                                onPressed: () {
                                  Navigator.pushNamed(context, '/hostelD');
                                }),
                          ],
                        ),
                      ),
