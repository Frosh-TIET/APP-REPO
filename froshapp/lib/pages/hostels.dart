...
class _HostelPageState extends State<HostelPage> {
  ...
  void _navigateToHostelDetail(List<Hostel> hostels, int index) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => HostelDetailPage(hostels: hostels, currentIndex: index),
      ),
    );
  }
                ...
                children: [
                  ...
                  CarouselSlider(
                    ...
                    items: widget.boysHostels
                      ...
                      onTap: () => _navigateToHostelDetail(widget.boysHostels, entry.key),
                      child: ClipRRect(
                  ...
                  CarouselSlider(
                    ...
                    items: widget.girlsHostels
                        ...
                        .entries
                        .map((entry) => GestureDetector(
                      onTap: () => _navigateToHostelDetail(widget.girlsHostels, entry.key),
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(16.0),
                        child: Image.asset(
                          entry.value.imageUrl,
